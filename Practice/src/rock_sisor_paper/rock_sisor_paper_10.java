...
public class rock_sisor_paper_10 {
	public static void main(String[] args) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (input.equals("0")) user = "가위";
			else if (input.equals("1")) user = "바위";
			else if (input.equals("2")) user = "보";
			...
			else if (user.equals("가위") && com == 0) {
				result = "무승부";
			}
			else if (user.equals("바위") && com == 1) {
				result = "무승부";
			}
			...
			if (result.equals("사용자 승리")) userWin++;
			else if (result.equals("컴퓨터 승리")) comWin++;
			else if (result.equals("무승부")) draw++;
			System.out.println("결과: " + result);
			System.out.println();
		}// 번째 게임 
		float per = ((float)userWin / (count) * 100);
		System.out.println("종료합니다.");
		System.out.println();
		System.out.println("게임 결과 ");
		System.out.println("-------------");
		System.out.println("사용자 승리: " + userWin + "회");
		System.out.println("컴퓨터 승리: " + comWin + "회");
